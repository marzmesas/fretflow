/** Writes static/fixtures/smoke.mid — one open high-e note for importer CI. */
...
const outPath = join(root, "static", "fixtures", "smoke.mid");
...
const midi: MidiData = {
  ...
  tracks: [
    ...
    [
      ...
      { deltaTime: 480, type: "noteOff", channel: 0, noteNumber: 64, velocity: 64 },
      { deltaTime: 0, meta: true, type: "endOfTrack" },
    ],
  ],
};
